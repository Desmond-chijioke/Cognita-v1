...
import {
  LuLayoutDashboard, LuBuilding, LuUsers,
...
const NAV_ITEMS = [
  { label: 'Overview',    icon: LuLayoutDashboard, path: APPROUTE_LIST.FACULTY_OVERVIEW    },
  { label: 'Departments', icon: LuBuilding,         path: APPROUTE_LIST.FACULTY_DEPARTMENTS },
  { label: 'Students',    icon: LuUsers,            path: APPROUTE_LIST.FACULTY_STUDENTS    },
  { label: 'Analytics',   icon: FiBarChart2,        path: APPROUTE_LIST.FACULTY_ANALYTICS   },
  { label: 'My Research', icon: LuFlaskConical,     path: APPROUTE_LIST.FACULTY_RESEARCH_EDITOR },
  { label: 'Messages',    icon: LuMessageSquare,    path: APPROUTE_LIST.FACULTY_MESSAGES    },
  { label: 'Settings',    icon: LuSettings,         path: APPROUTE_LIST.FACULTY_SETTINGS    },
];
