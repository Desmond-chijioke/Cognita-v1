...
import {
  LuLayoutDashboard, LuBuilding2, LuUsers,
...
const NAV_ITEMS = [
  { label: 'Overview',    icon: LuLayoutDashboard, path: APPROUTE_LIST.COLLEGE_OVERVIEW    },
  { label: 'Faculties',   icon: LuBuilding2,        path: APPROUTE_LIST.COLLEGE_FACULTIES   },
  { label: 'Students',    icon: LuUsers,            path: APPROUTE_LIST.COLLEGE_STUDENTS    },
  { label: 'Analytics',   icon: FiBarChart2,        path: APPROUTE_LIST.COLLEGE_ANALYTICS   },
  { label: 'My Research', icon: LuFlaskConical,     path: APPROUTE_LIST.COLLEGE_RESEARCH_EDITOR },
  { label: 'Messages',    icon: LuMessageSquare,    path: APPROUTE_LIST.COLLEGE_MESSAGES    },
  { label: 'Settings',    icon: LuSettings,         path: APPROUTE_LIST.COLLEGE_SETTINGS    },
];
